...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
                ...
                int startDay=ValuesGenerator.getRandomIntBetween(random, 0, 33);
			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setValid")){
                           ...
                           appt.setRecurrence(null, recur, recurIncrement, recurNumber);    //added to catch a branch
						}
                       else if (methodName.equals("isOn")){
                           int tempStartDay=ValuesGenerator.getRandomIntBetween(random, 1, 11);
                           int tempStartMonth=ValuesGenerator.getRandomIntBetween(random, 1, 11);
                           int tempStartYear=ValuesGenerator.getRandomIntBetween(random, 1, 2018);
                           appt.isOn(tempStartDay, tempStartMonth, tempStartYear);
                        }
				}
